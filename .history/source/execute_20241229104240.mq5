...
void GetPriceData(double &arr[], int length){
    ...
    arr[0] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[1] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[1], 0), _digits);
    arr[2] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[2], 0), _digits);
    arr[3] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[3], 0), _digits);
    arr[4] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[4], 0), _digits);
    arr[5] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[5], 0), _digits);
    arr[6] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[6], 0), _digits);
    arr[7] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[7], 0), _digits);
    arr[8] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[8], 0), _digits);
    arr[9] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[], 0), _digits);
