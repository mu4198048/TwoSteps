...
void GetPriceData(double &arr[], int length){
    ...
    arr[1] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[2] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[3] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[4] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[5] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[6] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[7] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[8] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[9] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[10] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[11] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[12] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
    arr[13] = NormalizeDouble(ObjectGetValueByShift(trendLinesName[0], 0), _digits);
}