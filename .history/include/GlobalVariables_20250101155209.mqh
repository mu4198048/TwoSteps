...
enum ReasonClose{ERROR, LOSS_CUT, TAKE_PROFITS, TRAILING_CLOSE, WEEKEND_CLOSE, GUI_CLOSE, TIME_CLOSE};
OrderType Enum_OrderType;
CommentList Enum_Comment;
PisitionType Enum_PositionType;
ReasonClose Enum_ClsType;
...
double lotSizeForTrade;
double openPriceForTrade;
string positionComment;
string reasonClose;

bool activateTrailingClose
