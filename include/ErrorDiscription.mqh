...
#ifndef __ErrorDiscription__
#define __ErrorDiscription__
...
string ErrorDescription(int err_code){
    ...
    case ERR_OPENCL_BUFFER_CREATE:         return("Failed to create and OpenCL buffer");
      //--- User-Defined Errors
    default: if(err_code>=ERR_USER_ERROR_FIRST && err_code<ERR_USER_ERROR_LAST) return ("User error "+string(err_code-ERR_USER_ERROR_FIRST));
    }
